...
func (e *EnhancedMenu) showHeader() {
	fmt.Println("┌─────────────────────────────────────────────────────────────────────────────┐")
	fmt.Printf("│                           BlendPDFGo v%-8s                           │\n", e.version)
	fmt.Println("├─────────────────────────────────────────────────────────────────────────────┤")
	fmt.Printf("│ Watch: %-67s │\n", e.watchDir)
	fmt.Printf("│ Archive: %-65s │\n", e.archiveDir)
	fmt.Printf("│ Output: %-66s │\n", e.outputDir)
	fmt.Printf("│ Error: %-67s │\n", e.errorDir)
	fmt.Println("└─────────────────────────────────────────────────────────────────────────────┘")
	fmt.Println()
}
...
func (e *EnhancedMenu) showStatus() {
	...
	fmt.Printf("Files: Main(%d) Archive(%d) Output(%d) Error(%d) | Session: %s\n",
		len(mainFiles), archiveCount, outputCount, errorCount, e.elapsedTime())
	fmt.Println()
...
func (e *EnhancedMenu) handleSingleFile() bool {
	...
	if err := e.fileOps.ProcessSingleFile(); err != nil {
		fmt.Printf("❌ Error: %v\n", err)
		e.errorCount++
	} else {
...
func (e *EnhancedMenu) handleMergeFiles() bool {
	...
	if err := e.fileOps.ProcessMergeFiles(); err != nil {
		fmt.Printf("❌ Error: %v\n", err)
		e.errorCount++
	} else {
...
func (e *EnhancedMenu) showStatistics() {
	...
	fmt.Println("├─────────────────────────────────────────────────────────────────────────────┤")
	fmt.Printf("│ Successful operations: %-49d │\n", e.successCount)
	fmt.Printf("│ Errors encountered: %-52d │\n", e.errorCount)
	fmt.Printf("│ Time elapsed: %-58s │\n", e.elapsedTime())
	fmt.Println("└─────────────────────────────────────────────────────────────────────────────┘")
	fmt.Println()
}
