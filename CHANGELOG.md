...
### Fixed
- Task organisation in documentation - all completed tasks now properly organised in Done section
- Removed duplicate T-042 task that was already completed in previous releases

### Changed
- Improved task management and documentation organisation
